...
export default function AdminPage() {
  return (
    <div className="w-full max-w-5xl mx-auto p-6">
      <h1 className="font-bold mb-8 text-center text-creoLim-200">
        Admin Dashboard
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="p-6 flex flex-col h-full">
            <h2 className="font-semibold text-creoPri-200 mb-2">Event Management</h2>
        ...
        >
          <div className="p-6 flex flex-col h-full">
            <h2 className="font-semibold text-creoPri-200 mb-2">Blog Management</h2>
